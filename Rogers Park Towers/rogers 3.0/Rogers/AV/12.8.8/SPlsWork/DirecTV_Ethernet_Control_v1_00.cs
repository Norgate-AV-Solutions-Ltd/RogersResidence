...
namespace UserModule_DIRECTV_ETHERNET_CONTROL_V1_00
{
    public class UserModuleClass_DIRECTV_ETHERNET_CONTROL_V1_00 : SplusObject
    {
...
object NAV_UP_OnPush_20 ( Object __EventInfo__ )
...
object NAV_DOWN_OnPush_21 ( Object __EventInfo__ )
...
object NAV_LEFT_OnPush_22 ( Object __EventInfo__ )
...
object NAV_RIGHT_OnPush_23 ( Object __EventInfo__ )
...
object SELECT_OnPush_24 ( Object __EventInfo__ )
...
object RED_OnPush_25 ( Object __EventInfo__ )
...
object GREEN_OnPush_26 ( Object __EventInfo__ )
...
object YELLOW_OnPush_27 ( Object __EventInfo__ )
...
object BLUE_OnPush_28 ( Object __EventInfo__ )
...
object CH_UP_OnPush_29 ( Object __EventInfo__ )
...
object CH_DOWN_OnPush_30 ( Object __EventInfo__ )
...
object PREV_OnPush_31 ( Object __EventInfo__ )
...
object DIGIT_0_OnPush_32 ( Object __EventInfo__ )
...
object DIGIT_1_OnPush_33 ( Object __EventInfo__ )
...
object DIGIT_2_OnPush_34 ( Object __EventInfo__ )
...
object DIGIT_3_OnPush_35 ( Object __EventInfo__ )
...
object DIGIT_4_OnPush_36 ( Object __EventInfo__ )
...
object DIGIT_5_OnPush_37 ( Object __EventInfo__ )
...
object DIGIT_6_OnPush_38 ( Object __EventInfo__ )
...
object DIGIT_7_OnPush_39 ( Object __EventInfo__ )
...
object DIGIT_8_OnPush_40 ( Object __EventInfo__ )
...
object DIGIT_9_OnPush_41 ( Object __EventInfo__ )
...
object DASH_OnPush_42 ( Object __EventInfo__ )
...
object ENTER_OnPush_43 ( Object __EventInfo__ )
...
object DTV_COMMAND_TCPCLIENT_OnSocketStatus_44 ( Object __Info__ )
...
object DTV_COMMAND_TCPCLIENT_OnSocketConnect_45 ( Object __Info__ )
    ...
    try
    {
        SplusExecutionContext __context__ = SplusThreadStartCode(__SocketInfo__);
        CrestronString SGET;
        SGET  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 4096, this );
...
object DTV_COMMAND_TCPCLIENT_OnSocketReceive_46 ( Object __Info__ )
    ...
    try
    {
        ...
        SDUMP  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 4096, this );
...
public override void LogosSplusInitialize()
{
    ...
    DTV_COMMAND_TCPCLIENT  = new SplusTcpClient ( 4096, this );
    ...
    NAV_UP.OnDigitalPush.Add( new InputChangeHandlerWrapper( NAV_UP_OnPush_20, false ) );
    NAV_DOWN.OnDigitalPush.Add( new InputChangeHandlerWrapper( NAV_DOWN_OnPush_21, false ) );
    NAV_LEFT.OnDigitalPush.Add( new InputChangeHandlerWrapper( NAV_LEFT_OnPush_22, false ) );
    NAV_RIGHT.OnDigitalPush.Add( new InputChangeHandlerWrapper( NAV_RIGHT_OnPush_23, false ) );
    SELECT.OnDigitalPush.Add( new InputChangeHandlerWrapper( SELECT_OnPush_24, false ) );
    RED.OnDigitalPush.Add( new InputChangeHandlerWrapper( RED_OnPush_25, false ) );
    GREEN.OnDigitalPush.Add( new InputChangeHandlerWrapper( GREEN_OnPush_26, false ) );
    YELLOW.OnDigitalPush.Add( new InputChangeHandlerWrapper( YELLOW_OnPush_27, false ) );
    BLUE.OnDigitalPush.Add( new InputChangeHandlerWrapper( BLUE_OnPush_28, false ) );
    CH_UP.OnDigitalPush.Add( new InputChangeHandlerWrapper( CH_UP_OnPush_29, false ) );
    CH_DOWN.OnDigitalPush.Add( new InputChangeHandlerWrapper( CH_DOWN_OnPush_30, false ) );
    PREV.OnDigitalPush.Add( new InputChangeHandlerWrapper( PREV_OnPush_31, false ) );
    DIGIT_0.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_0_OnPush_32, false ) );
    DIGIT_1.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_1_OnPush_33, false ) );
    DIGIT_2.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_2_OnPush_34, false ) );
    DIGIT_3.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_3_OnPush_35, false ) );
    DIGIT_4.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_4_OnPush_36, false ) );
    DIGIT_5.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_5_OnPush_37, false ) );
    DIGIT_6.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_6_OnPush_38, false ) );
    DIGIT_7.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_7_OnPush_39, false ) );
    DIGIT_8.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_8_OnPush_40, false ) );
    DIGIT_9.OnDigitalPush.Add( new InputChangeHandlerWrapper( DIGIT_9_OnPush_41, false ) );
    DASH.OnDigitalPush.Add( new InputChangeHandlerWrapper( DASH_OnPush_42, false ) );
    ENTER.OnDigitalPush.Add( new InputChangeHandlerWrapper( ENTER_OnPush_43, false ) );
    DTV_COMMAND_TCPCLIENT.OnSocketStatus.Add( new SocketHandlerWrapper( DTV_COMMAND_TCPCLIENT_OnSocketStatus_44, false ) );
    DTV_COMMAND_TCPCLIENT.OnSocketConnect.Add( new SocketHandlerWrapper( DTV_COMMAND_TCPCLIENT_OnSocketConnect_45, false ) );
    DTV_COMMAND_TCPCLIENT.OnSocketReceive.Add( new SocketHandlerWrapper( DTV_COMMAND_TCPCLIENT_OnSocketReceive_46, false ) );
...
public UserModuleClass_DIRECTV_ETHERNET_CONTROL_V1_00 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
...
const uint SELECT__DigitalInput__ = 23;
const uint RED__DigitalInput__ = 24;
const uint GREEN__DigitalInput__ = 25;
const uint YELLOW__DigitalInput__ = 26;
const uint BLUE__DigitalInput__ = 27;
const uint CH_UP__DigitalInput__ = 28;
const uint CH_DOWN__DigitalInput__ = 29;
const uint PREV__DigitalInput__ = 30;
const uint DIGIT_0__DigitalInput__ = 31;
const uint DIGIT_1__DigitalInput__ = 32;
const uint DIGIT_2__DigitalInput__ = 33;
const uint DIGIT_3__DigitalInput__ = 34;
const uint DIGIT_4__DigitalInput__ = 35;
const uint DIGIT_5__DigitalInput__ = 36;
const uint DIGIT_6__DigitalInput__ = 37;
const uint DIGIT_7__DigitalInput__ = 38;
const uint DIGIT_8__DigitalInput__ = 39;
const uint DIGIT_9__DigitalInput__ = 40;
const uint DASH__DigitalInput__ = 41;
const uint ENTER__DigitalInput__ = 42;
